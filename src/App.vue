  ...
  <div id = 'wrapper'>
    ...
    <nav class="navbar is-dark">   
      <div class="navbar-brand">
          <router-link to="/" class="navbar-item"><strong>Suinming jacket</strong></router-link>
    ...
    <!-- footer -->
    <footer class='footer'>
      <p class="has-text-centered">Copyright (c) 2022 by suinming</p>
    </footer>
  </div>
</template>
